package ru.itmo.zavar.highload.zorthprocessor.config.resilience;
...
public class CircuitBreakerConfiguration {
    ...
    public CircuitBreaker userServiceClientCircuitBreaker(CircuitBreakerConfig circuitBreakerConfig) {
        return circuitBreakerRegistry.circuitBreaker("ZorthTranslatorClientCB", circuitBreakerConfig);
    }
}
